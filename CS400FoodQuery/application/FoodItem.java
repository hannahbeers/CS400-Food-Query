...
public class FoodItem {
    ...
    /**
     * Constructor, takes name and unique id parameters.
    ...
    public double getNutrientValue(String name) {
    	/*
    	 * Doesn't allow name to be null and ensures that nutrients contains the key
    	 * passed in. Also makes sure that the value at that key is not equal to null.
    	 * If it is, return 0 instead of null.
    	 */
    	if(name != null && nutrients.containsKey(name) && nutrients.get(name) != null) {
